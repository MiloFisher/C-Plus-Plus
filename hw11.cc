...
bool custom_sort(int x, int y)//sorts even first, then odd in ascending order
{
...
int main()
{
    ...
    //Doesn't Work bc fcnPtr1 is for a string function, not an int one -> fcnPtr1 = boo; // [1.4] assign fcnPtr1 to point to boo
...
// dPtr points to the D2::function1() because function1() is defined in D2 and dPtr points to a reference of D2.

// Q#5

// You would lose all aspects unique to the derived class because it is getting sliced into a base class.
